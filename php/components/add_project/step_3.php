<section class="section-add-project register__step_3">
    <div class="container">
        ...
        <div class="section-forms">
           <input type="file" name="telegram" class="section-add-project__input" placeholder="Загрузить изображение"/>
        </div>
        <div class="section-controls">
            <button type="submit" class="section-add-project__button_next next_2">Далее</button>
