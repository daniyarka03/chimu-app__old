...
<section class="section-register register__step_3">
    <div class="container">
        ...
        <div class="block__span">
            ...
            <input type="text" name="social_media_instagram" class="section-register__input" placeholder="Instagram (Необязательно)" />
            <!-- <input type="text" name="social_media_vk" class="section-register__input" placeholder="Vk" /> -->
            <input type="text" name="social_media_telegram" class="section-register__input" placeholder="Telegram (Необязательно)" />
        </div>
