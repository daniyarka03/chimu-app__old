    ...
    <main>
        ...
        <section class="search-sort">
            ...
            <div class="search-sort__block">
                ...
                <a href='?query=<?= $_GET['query'] ?>&&type=first_name&&sort=<?= $status ?>'><button
                        class="search-sort__btn" type="submit">По алфавиту <img class="search-sort__status"
                            src="img/search/Forward.svg" /> </button></a>
                <a href='?query=<?= $_GET['query'] ?>&&type=work_activity&&sort=<?= $status ?>'><button
                ...
                <a href='?type=id&&sort=<?= $status ?>'><button class="search-sort__btn" type="submit"
                        value="По дате">По дате <img class="search-sort__status"
                            src="img/search/Forward.svg" /></button></a>
                <a href='?type=first_name&&sort=<?= $status ?>'><button class="search-sort__btn" type="submit">По
                        алфавиту <img class="search-sort__status" src="img/search/Forward.svg" /></button></a>
                <a href='?type=work_activity&&sort=<?= $status ?>'><button class="search-sort__btn" type="submit">По
                        тегам <img class="search-sort__status" src="img/search/Forward.svg" /></button></a>
        ...
        <section class="section section-card">
            <div class="container">
                <div class="section-card__content">
                    <img src="uploades/profile_photo/<?= $user['avatar'] ?? "default.JPG"  ?>" alt="logo" class="section-card__img">
